...
gulp.task(
  "themeforest:build",
  require(GLOBAL.dirs.gulp + "themeforest/build")(GLOBAL, gulp)
);
gulp.task(
  "themeforest:pixelate",
  require(GLOBAL.dirs.gulp + "themeforest/pixelate")(GLOBAL, gulp)
);
gulp.task(
  "themeforest:mailconfig",
  require(GLOBAL.dirs.gulp + "themeforest/mailconfig")(GLOBAL, gulp)
);
gulp.task(
  "themeforest:zip",
  require(GLOBAL.dirs.gulp + "themeforest/zip")(GLOBAL, gulp)
);

gulp.task("default", ["sass", "jade", "watch"]);

gulp.task("once", ["sass", "jade"]);
